odoo.define('pos_customer_facing_display.ClientScreenButton', function(require) {
    'use strict';
    ...
    const ClientScreenButtonExtend = (ClientScreenButton) =>
    ...
    Registries.Component.extend(ClientScreenButton, ClientScreenButtonExtend);
