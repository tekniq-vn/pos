odoo.define('pos_tare.models', function (require) {
    ...
    models.Orderline = models.Orderline.extend({
        ...
        initialize: function (attributes, options) {
            this.tare = 0;
            return orderline_super.initialize.apply(this, arguments);
        },
        ...
        clone: function () {
            var orderline = orderline_super.clone.apply(this, arguments);
        ...
        export_for_printing: function () {
            var result = orderline_super.export_for_printing.apply(this, arguments);
    ...
    models.Order = models.Order.extend({
        add_product: function(product, options) {
            ...
            if (options.tare !== undefined) {
                this.selected_orderline.set_tare(options.tare, false);
            }
        },
    });
